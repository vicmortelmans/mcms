...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/" mode="create-page-masters">
    ...
    <fo:simple-page-master master-name="front-matter-first" xsl:use-attribute-sets="simple-page-master">
      ...
      <xsl:message>Plugin com.agfa.radsol.dod layout-masters.xsl template "create-page-masters" add footer on cover</xsl:message>  
      <fo:region-after extent="{$page-margin-bottom}" display-align="after" region-name="first-frontmatter-footer"/>
